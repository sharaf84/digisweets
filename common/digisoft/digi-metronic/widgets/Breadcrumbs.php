...
class Breadcrumbs extends \yii\widgets\Breadcrumbs {
    ...
    /**
     * @var string the template used to render home item in the breadcrumbs. The token `{link}`
     * will be replaced with the actual HTML link for each inactive item.
     */
    public $homeItemTemplate = "<li><i class=\"fa fa-home\"></i>&nbsp;{link}&nbsp;<i class=\"fa fa-angle-right\"></i></li>\n";
