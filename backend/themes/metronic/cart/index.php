...
/* @var $searchModel common\models\custom\search\Cart */
...
<div class="page-content cart-index">
        ...
        <div class="page-toolbar">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <?= Html::a(Yii::t('app', 'Create Cart'), ['create'], ['class' => '']) ?>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-cascade">
                <div class="portlet-title">
                    ...
                    <div class="tools">
                        <!--<a href="javascript:;" class="reload" onclick="$.pjax.reload({container: #pjaxCartGrid});"></a>-->
