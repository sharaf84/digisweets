...
<div class="page-content">
	...
	<div class="page-depth">
		...
		<li><a href="index.html"><?= Html::encode('Home') ?></a></li>
                <li><a href="<?= Url::to(['categories/index']) ?>"><?= Html::encode($oProduct->category->name) ?></a></li>
		<li><a href="<?= Url::to(['products/food-service', 'category_id' => $oProduct->category_id]) ?>"><?= Html::encode('Products') ?></a></li>
